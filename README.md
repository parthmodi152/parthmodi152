...
I invest in and build the systems layer beneath AI. At Array, I source deals, do technical diligence, and build prototypes to stress-test ideas before writing checks. If the architecture doesn't hold up under inspection, neither does the investment.
...
University of Waterloo, Computer Science. Previously software engineering at theScore (now ESPN Bet). Now full-time digging into the infrastructure that makes AI agents actually work.
